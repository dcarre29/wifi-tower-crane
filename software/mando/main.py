...
def electronica(): #Verificamos el estado de la electronica del mando
    global x, y, z
    while True: 
        x = js.getAxis("x")
        y = js.getAxis("y")
...
def comunicacion(): #Enviamos y recibimos las variables
...
def grafica(): 
    ...
    while True: 
        ...
        cv2.putText(img,"Distcarro:", (0,205), cv2.FONT_HERSHEY_SIMPLEX, 0.5, 255,1)
...
hilo1 = Thread(target=comunicacion)
hilo2 = Thread(target=grafica)
hilo3 = Thread(target=electronica)
